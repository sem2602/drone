...
$sql = "SELECT id, code, hesh, status FROM kasco_tokens WHERE code = :code";
...
$sql = "UPDATE kasco_tokens SET hesh = :hesh WHERE id = :id";
$stmt = $pdo->prepare($sql);
$params = [':id' => $result['id'], ':hesh' => $hesh];
$stmt->execute($params);

$form = '<form id="form_kasco_add" onsubmit="return false">

<div class="modal-header">
  <h5 class="modal-title" id="staticBackdropLabel">Каско № - '. $result['code'] .'</h5>
